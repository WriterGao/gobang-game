...
QT_MOC_LITERAL(1, 11, 10), // "pieceAdded"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 8), // "position"
QT_MOC_LITERAL(4, 32, 9), // "PieceType"
QT_MOC_LITERAL(5, 42, 4), // "type"
QT_MOC_LITERAL(6, 47, 12), // "pieceRemoved"
QT_MOC_LITERAL(7, 60, 12) // "boardCleared"

    },
    "ChessBoard\0pieceAdded\0\0position\0"
    "PieceType\0type\0pieceRemoved\0boardCleared"
};
...
void ChessBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pieceAdded((*reinterpret_cast< const QPoint(*)>(_a[1])),(*reinterpret_cast< PieceType(*)>(_a[2]))); break;
        case 1: _t->pieceRemoved((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        ...
        {
            using _t = void (ChessBoard::*)(const QPoint & , PieceType );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChessBoard::pieceAdded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ChessBoard::*)(const QPoint & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChessBoard::pieceRemoved)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChessBoard::boardCleared)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void ChessBoard::pieceAdded(const QPoint & _t1, PieceType _t2)
{
...
// SIGNAL 1
void ChessBoard::pieceRemoved(const QPoint & _t1)
{
