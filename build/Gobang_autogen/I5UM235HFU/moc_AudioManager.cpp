...
QT_MOC_LITERAL(5, 48, 5) // "muted"

    },
    "AudioManager\0volumeChanged\0\0volume\0"
    "mutedChanged\0muted"
};
...
void AudioManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (AudioManager::*)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AudioManager::volumeChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AudioManager::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AudioManager::mutedChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void AudioManager::volumeChanged(float _t1)
{
